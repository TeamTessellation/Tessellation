...
//             else
//             {
//                 soundEmitter = PoolManager.Instance.Get(PoolManager.Poolables.SoundEmitter).GetComponent<SoundEmitter>();
//                 soundEmitter.transform.SetParent(transform);
//                 soundEmitter.transform.position = Vector3.zero;
//                 AudioSource audioSource = soundEmitter.GetComponent<AudioSource>();
...
//             if (clip == null)
//                 return;
//             SoundEmitter soundEmitter = PoolManager.Instance.Get(PoolManager.Poolables.SoundEmitter).GetComponent<SoundEmitter>();
//             soundEmitter.transform.SetParent(transform);
...
//                     audioSource.Stop();
//                     soundEmitter.transform.SetParent(null);
//                     PoolManager.Instance.Release(soundEmitter.GetComponent<Poolable>());
//                 }
//                 _currentPlayingBackgroundMusicPath = string.Empty;
//             }
//         }

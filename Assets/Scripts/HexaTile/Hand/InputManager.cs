...
public class InputManager : MonoBehaviour, IPlayerTurnLogic, IBasicTurnLogic
{
    ...
    public void SetItem()
    {
        ...
        {
            case eActiveItemType.Add: // �׽�Ʈ ��
                UseItemAction = AddTileSetItem;
                break;
            case eActiveItemType.Delete: // �׽�Ʈ ��
            ...
            case eActiveItemType.Rotate:
                ...
                break;
            case eActiveItemType.Overwrite: // �׽�Ʈ ��
                UseItemAction = OverwriteSetItem;
                break;
            case eActiveItemType.Reroll: // �׽�Ʈ ��
    ...
    {
        return (HandManager.Instance.HandCount > 0); // ToDo �ڵ� ����
    }
